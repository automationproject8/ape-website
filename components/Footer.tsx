export default function Footer() {
  ...
  const socials = [
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/advanced-pro-engineering-7984562a0/',
      icon: (
    ...
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/profile.php?id=61581325828804',
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'TikTok',
      href: 'https://www.tiktok.com/@advancedproengineering',
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-[#4a7aa8] text-xs leading-relaxed font-light mb-5">
            ...
            <div className="flex items-center gap-3">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.name}
                  className="w-8 h-8 rounded flex items-center justify-center text-[#4a7aa8] border border-[#2d5a8e]/50 hover:border-[#4a7aa8] hover:text-[#8fb3d4] transition-all duration-300"
                >
                  {s.icon}
                </a>
              ))}
          ...
          <div className="flex items-center gap-4">
            {socials.map((s) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#2d5a8e] hover:text-[#4a7aa8] transition-colors text-xs tracking-wider"
              >
                {s.name}
              </a>
            ))}
